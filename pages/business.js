...
const defaultNewsSource = 'business-insider';
...
//         <h2>Business News from {source.split("-").join(" ")}</h2>
//         <div>
//           {props.articles.map(article => (
//             <section>
//               <h3>{article.title}</h3>
//               <p className="author">{article.author}{article.pubishedAt}</p>
//               <img src={article.urlToImage} alt="article image" className="img-article"></img>
//               <p>{article.description}</p>
//               <p>{article.content}</p>
